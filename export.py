...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", nargs="+", type=str, default=ROOT / "runs/train/exp264/weights/best.pt", help="model.pt path(s)") #yolov5s.pt
    parser.add_argument("--imgsz", "--img", "--img-size", nargs="+", type=int, default=[960, 960], help="image (h, w)")
    ...
    parser.add_argument("--dynamic", action="store_true", help="ONNX/TF/TensorRT: dynamic axes")  #动态尺寸
    parser.add_argument("--simplify", action="store_true",default=True, help="ONNX: simplify model")   #简化模型，（部署丢失精度）
    parser.add_argument("--opset", type=int, default=12, help="ONNX: opset version")   #17默认报错：：不支持  12老版本
    ...
    parser.add_argument("--conf-thres", type=float, default=0.2, help="TF.js NMS: confidence threshold") #置信度
    parser.add_argument(
        "--include",
        nargs="+",
        default=["onnx"],

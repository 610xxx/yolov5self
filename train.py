...
#GIT_INFO = check_git_info()       # 报错git.exc.GitCommandNotFound: Cmd('git') not found due to: FileNotFoundError('[WinError 2] 系统找不到指定的文件。')cmdline: git cat-file --batch-check
...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "yolov5s.pt", help="initial weights path")  #runs/train/exp151/weights/best.pt
    parser.add_argument("--cfg", type=str, default=ROOT / "models/magick.yaml", help="model.yaml path") #factotum
    parser.add_argument("--data", type=str, default=ROOT /'data/germany.yaml', help="dataset.yaml path") # "data/coco128.yaml"    limit
    ...
    parser.add_argument("--evolve", type=int, nargs="?", const=300, default=False, help="evolve hyperparameters for x generations")   #超参进化

...
# CBAM 注意力机制之一：空间和通道两个注意力，计算复杂   🚀🚀
class ChannelAttention(nn.Module):
    def __init__(self, in_planes, ratio=16): #输入张量//out_planes为输出张量
...
# BiFPN*********************************************************************************🚀🚀🚀🚀🚀
class BiFPN_Add2(nn.Module):#添加add
